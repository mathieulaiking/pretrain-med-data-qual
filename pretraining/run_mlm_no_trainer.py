...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path of local dataset (already tokenized and preprocessed)",
    )
    parser.add_argument(
        "--pad_to_max_length",
        action="store_true",
...
def main():
    ...
    # Load the pre-processed pubmed dataset
    ...
    if args.filter_metric is not None:
        ...
        tokenized_datasets = tokenized_datasets.filter(
            ...
            fn_kwargs={
                ...
                "lower_threshold": args.filter_lower_threshold,
                "upper_threshold": args.filter_upper_threshold,
            },
            num_proc=args.preprocessing_num_workers,
            load_from_cache_file=not args.overwrite_cache,
            desc=f"Filtering examples where {args.filter_lower_threshold} <= {args.filter_metric} <= {args.filter_upper_threshold}",
        )
